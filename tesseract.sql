...
CREATE TABLE IF NOT EXISTS `tesseract`.`utilisateur` (
  ...
  CONSTRAINT `fk_users_organisations1`
    ...
    REFERENCES `tesseract`.`organisation` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`reclamation` (
  ...
  CONSTRAINT `fk_reclamation_utilisateur1`
    ...
    REFERENCES `tesseract`.`utilisateur` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`cours` (
  ...
  INDEX `fk_cours_utilisateur1_idx` (`id_utilisateur` ASC),
  CONSTRAINT `fk_cours_matiere1`
    FOREIGN KEY (`id_matiere`)
    REFERENCES `tesseract`.`matiere` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `tesseract`.`objectif` (
  ...
  CONSTRAINT `fk_objectif_chapitre1`
    ...
    REFERENCES `tesseract`.`chapitre` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`epreuve` (
  ...
  CONSTRAINT `fk_epreuve_objectif1`
    ...
    REFERENCES `tesseract`.`objectif` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`question` (
  ...
  CONSTRAINT `fk_question_epreuve1`
    ...
    REFERENCES `tesseract`.`epreuve` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`reponse` (
  ...
  CONSTRAINT `fk_reponse_question1`
    ...
    REFERENCES `tesseract`.`question` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`commentraire_forum` (
  ...
  CONSTRAINT `fk_utilisateur_has_sujet_forum_sujet_forum1`
    ...
    REFERENCES `tesseract`.`sujet_forum` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`inscription_evenement` (
  ...
  CONSTRAINT `fk_evenement_has_utilisateur_evenement1`
    ...
    REFERENCES `tesseract`.`evenement` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `tesseract`.`probleme`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tesseract`.`probleme` (
  `id` INT NOT NULL,
  `probleme` TEXT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`challenge` (
  ...
  INDEX `fk_challenge_probleme1_idx` (`id_probleme` ASC),
  CONSTRAINT `fk_challenge_organisation1`
    FOREIGN KEY (`id_organisation`)
    REFERENCES `tesseract`.`organisation` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_challenge_probleme1`
    FOREIGN KEY (`id_probleme`)
    REFERENCES `tesseract`.`probleme` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tesseract`.`inscription_challenge` (
  ...
  CONSTRAINT `fk_utilisateur_has_challenge_challenge1`
    ...
    REFERENCES `tesseract`.`challenge` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
